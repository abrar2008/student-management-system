...
class QuizList extends Component {
  constructor() {
    ...
    this.state = {
      quiz_list: [
        { quizName: "REACT", tests: 2 },
        { quizName: "NODE JS", tests: 1 },
        { quizName: "FIREBASE", tests: 3 }
      ],
      quiz_info: [
        {
          quizName: "REACT",
          tests: [
            {
              ...
              quiz_questions: [
                {
                  quiz: "What is abbreviation of REACT?",
                ...
                {
                  quiz: "How many types of markup in REACT?",
                  option1: "Both",
                ...
                {
                  quiz: "REACT must need body markup. Why? Because:",
            ...
            },
            {
              ...
              quiz_questions: [
                {
                  quiz:
                    "The external FIREBASE file must contain the <script> tag.",
                  option1: "True",
                  option2: "False",
                  option3: "Neither true nor false",
                  option4: "None of above",
                ...
                {
                  quiz:
                    "Choose the correct REACT element for the largest heading:",
                  option1: "<h6>",
                  option2: "<heading>",
                  option3: "<h1>",
                  option4: "<head>",
                ...
                {
                  quiz:
                    "What is the correct REACT element for inserting a line break?",
                  option1: "<break>",
                  option2: "<br>",
                  option3: "<lnbr>",
                  option4: "none of above",
                ...
                {
                  quiz:
                    "What is the correct REACT for adding a background color?",
                ...
                {
                  quiz:
                    "Choose the correct REACT element to define important text",
                  option1: "<strong>",
                  option2: "<b>",
                  option3: "<important>",
                  option4: "<i>",
                ...
                {
                  quiz:
                    "Choose the correct REACT element to define emphasized text",
                  option1: "<i>",
                  option2: "<emphasize>",
                  option3: "<italic>",
                  option4: "<em>",
                ...
                {
                  quiz: "What is the correct REACT for creating a hyperlink?",
          ...
          tests: [
            {
              ...
              quiz_questions: [
                {
                  quiz: "What does NODE JS stand for?",
                ...
                {
                  quiz:
                    "Where in an REACT document is the correct place to refer to an external style sheet?",
                ...
                {
                  quiz:
                    "Which REACT tag is used to define an internal style sheet?",
                  option1: "<script>",
                  option2: "<style>",
                  option3: "<NODE JS>",
                  option4: "<pre>",
                ...
                {
                  quiz: "Which is the correct NODE JS syntax?",
                ...
                {
                  quiz: "How do you insert a comment in a NODE JS file?",
                ...
                {
                  quiz: "Which NODE JS property controls the text size?",
                  option1: "font-size",
                  option2: "text-style",
                  option3: "text-size",
                  option4: "font-style",
                ...
                {
                  quiz:
                    "What is the correct NODE JS syntax for making all the <p> elements bold?",
                ...
                },
                {
                  ...
                  option3: "You can't do that with NODE JS",
          ...
          tests: [
            {
              ...
              quiz_questions: [
                {
                  quiz:
                    'What is the correct FIREBASE syntax to change the content of this <p id="demo">This is a demonstration.</p> REACT element?',
                  option1:
                    'document.getElementByName("p").innerREACT = "Hello World!";',
                  option2:
                    'document.getElement("p").innerREACT = "Hello World!";',
                  option3:
                    'document.getElementById("demo").innerREACT = "Hello World!";',
                  option4: '#demo.innerREACT = "Hello World!";',
                  answer: "3"
                },
                {
                  quiz: "Where is the correct place to insert a FIREBASE?",
                  option1:
                    "Both the <head> section and the <body> section are correct",
                  option2: "The <body> section",
                  option3: "The <head> section",
                  option4: "afer the <!DOCTYPE REACT> declaration",
                  answer: "1"
                },
                {
                ...
                {
                  quiz: "How do you create a function in FIREBASE?",
                ...
                {
                  quiz: "How to write an IF statement in FIREBASE?",
                  option1: "if i = 5 then",
                  option2: "if i = 5",
                  option3: "if (i == 5)",
                  option4: "if i == 5 then",
            ...
            },
            {
              ...
              quiz_questions: [
                ...
                {
                  quiz: "How can you add a comment in a FIREBASE?",
                  option1: "//This is a comment",
                  option2: "<!--This is a comment-->",
                  option3: "'This is a comment",
                  option4: "#This is a comment#",
                ...
                {
                  quiz: "What is the correct way to write a FIREBASE array?",
            ...
            },
            {
              ...
              quiz_questions: [
                ...
                {
                  quiz:
                    'What is the correct FIREBASE syntax for opening a new window called "w2" ?',
                ...
                {
                  quiz: "FIREBASE is the same as Java.",
                  option1: "True",
                  option2: "False",
                  option3: "Neither true nor false",
                  option4: "none of above",
                ...
                {
                  quiz:
                    "Which event occurs when the user clicks on an REACT element?",
                ...
                {
                  quiz: "How do you declare a FIREBASE variable?",
                  option1: "v carName;",
  ...
  renderQuizInfo() {
    ...
    return (
      <div>
              ...
              >
                <div class="card" style={{ width: "13rem" }}>
                  ...
                  <div class="card-body">
                    ...
                    >
                      Start Quiz {i + 1} <i class=" fa fa-paper-plane" />
                    </button>
                  </div>
                </div>
              </div>
        ...
        <br />
        <button class="btn btn-secondary" onClick={this.back}>
          Back <i class="fa fa-backward" />
        </button>
      </div>
    );
  }
      ...
      <div>
        ...
        <div class="row">
          {quiz_list.map((qList, index) => {
            return (
              <div class="col-md-4" key={`${qList}_${index}`}>
                <div class="card" style={{ width: "13rem" }}>
                  <img
                    class="card-img-top"
                    src={coverPic1}
                  ...
                  />
                  <div class="card-body">
                    <h5 class="card-title">{qList.quizName} Quiz</h5>
                    <p class="card-text">
                    ...
                    {/* <button class="btn btn-primary" >Next <i class=" fa fa-paper-plane"></i></button> */}
                  </div>
                </div>
              </div>
            );
